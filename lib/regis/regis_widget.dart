...
import 'regis_model.dart';
export 'regis_model.dart';
...
class _RegisWidgetState extends State<RegisWidget> {
  late RegisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisModel());
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  context.goNamedAuth('DecisionPage', mounted);
                                },
                                text: 'Create Account',
