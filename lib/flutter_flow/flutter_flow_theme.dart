...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0000FF);
  late Color secondary = const Color(0xFFF26BDC);
  late Color tertiary = const Color(0xFF5CE1E6);
  late Color alternate = const Color(0xFFFFBD59);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFF1D1C40);
