...
import 'drinkatbar_model.dart';
export 'drinkatbar_model.dart';

class DrinkatbarWidget extends StatefulWidget {
  const DrinkatbarWidget({
    Key? key,
    this.userDocument,
    this.chatDocument,
    this.chatRef,
  ...
  @override
  _DrinkatbarWidgetState createState() => _DrinkatbarWidgetState();
}

class _DrinkatbarWidgetState extends State<DrinkatbarWidget> {
  late DrinkatbarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrinkatbarModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        FFAppState().removeFromBots(currentUserReference!);
      });
    });
  }
              ...
              StreamBuilder<List<ChatsRecord>>(
                stream: queryChatsRecord(
                  queryBuilder: (chatsRecord) =>
                      chatsRecord.where('catagory', isEqualTo: 'bar'),
                ),
